...
const createSmallFlow = async () => {
  ...
  await fbCreate(
    "step",
    {
      ...
      flowKey: ref.id,
      template:
        "Give me a similar name to: {{name}}, then pronounce it using the textToSpeech function",
      responseDescription: "Hi this is you [{{name}}]({{textToSpeechLink}})",
      variableDescriptions: {
        name: {
      ...
      outputVariableDescriptions: {
        ...
        textToSpeechLink: {
          description: "url for the audio you generated",
          createdAt: Timestamp.fromMillis(4001),
        },
      },
    },
    {
  ...
  await fbCreate(
    "step",
    {
      ...
      functionInformation: {
        ...
        responseVariableName: `namePrononunciation`,
      },
    },
    {
      id: "2-step2",
